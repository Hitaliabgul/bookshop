...
function Navbar() {
    ...
    return (
        <>
            ...
            ${sticky
                    ? " sticky-navbar shadow-md bg-base-200 duration-300 transititon-all erase-in-out dark:bg-slate-600 dark-text-white"
                    : ""}`}>
                    ...
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                                ...
                                <ul className="p-2 font-m font-sans">
                                    {navItems}
                                </ul>

                            </ul>
                        </div>
                        <a className="font-bold font-mono text-2xl">BookStore</a>
                    </div>
